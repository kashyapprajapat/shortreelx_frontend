...
//       // Mock response data
//       const mockHashtags = [
//         "#ContentCreator", "#VideoStrategy", "#YouTubeGrowth", "#TikTokTips", 
//         "#InstagramReels", "#ViralContent", "#VideoMarketing", "#SocialMediaTips", 
//         "#DigitalContent", "#CreatorEconomy", "#VideoEditing", "#ContentStrategy", 
//         "#EngagementTips", "#SocialGrowth", "#CreativeContent"
//       ];
...
//               <h3 className="font-medium mb-3 text-gray-800 dark:text-gray-200">Generated Hashtags</h3>
//               <div className="bg-gray-50 dark:bg-gray-700 p-4 rounded-lg mb-4 text-left overflow-x-auto">
...
//               <li className="mb-2">Optimized for maximum discoverability</li>
//               <li className="mb-2">Balanced mix of broad and niche hashtags</li>
//               <li className="mb-2">Tailored to selected platforms</li>
//               <li className="mb-2">Based on your video content and subtitles</li>
//             </ul>
//           </div>
//         )}
//       </main>
